...
class L2ReportGenerator:
    ...
    def _generate_footer(self):
        ...
        lines = [
            ...
            "",
            "Plots:",
            "  - L2_analytical_solution.png : Analytical solution curves",
        ]
        
        if self.comparison_results:
            lines.append("  - L2_comparison.png          : Comparison with L1 numerical solution")
        
        lines.extend([
            "",
            "Data files:",
            "  - L2_solution.npy            : Analytical solution data for L3/L4",
            "  - L2_formulas.txt            : Analytical formulas reference",
            "",
            "Reports:",
            "  - L2_results.txt             : This detailed report",
            "",
            "=" * 80,
            "END OF REPORT",
